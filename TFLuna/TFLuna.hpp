...
// changed by Julian Bischof to work with Raspberry pico RP2040
...
{
public:
    TFLuna(uint8_t scl_pin, uint8_t sda_pin, uint8_t int_pin, i2c_inst_t *i2c, uint8_t i2c_addr);
    ~TFLuna();
    ...
    bool readReg(uint8_t reg, uint8_t *buffer);
